<?php
    ...
    $resultSet = $mysqli->query("SELECT * FROM plan_assignment WHERE batch_id = '$batch_id' AND datediff('$cDate', assignment_date) < 30 ORDER BY datediff('$cDate', assignment_date) ASC");
?>
